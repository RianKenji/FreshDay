        ...
        <ul class="navbar-nav bg-custom sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-icon">
                    <img src="img/logo1.jpg" alt="" style="width: 85px; height:100%;">
                </div>
                <div class="sidebar-brand-text mx-3">FreshDay 1.0</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="reviews2.php">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><strong>Hello!</strong> <?php echo htmlspecialchars($_SESSION['admin_name']); ?></span>
